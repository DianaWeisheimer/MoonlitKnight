...
public class PlayerCharacter : Character
{
    ...
    private void Start()
    {
        ...
        if (!inventory) { inventory = GetComponent<PartyMemberInventory>(); }
    ...
    {
        job = newJob;
        animations.ChangeAnimations(newJob.jobAnimations);
    }

    /*public void OnEnable()
    {
        GameEventsManager.instance.inputEvents.onAbilityPressed += abilityHolder.AbilityPressed;
        GameEventsManager.instance.inputEvents.onChangeAbilityPressed += abilityHolder.SwitchAbility;
    }
